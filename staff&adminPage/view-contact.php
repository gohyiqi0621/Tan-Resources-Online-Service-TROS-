...
$stmt = $conn->prepare("SELECT id, name, email, mobile_no, reference, service, message, created_at FROM contact_form_submissions ORDER BY created_at DESC");
$stmt->execute();
                    ...
                    <div class="card radius-10 rounded-4 mb-3">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <!-- Left Section: User Info & Message -->
                                <div class="d-flex align-items-start" style="max-width: 75%;">
                                    ...
                                    <div>
                                        ...
                                        <p><strong>Mobile:</strong> <?= htmlspecialchars($row['mobile_no']) ?></p>
                                        <p><strong>Reference:</strong> <?= htmlspecialchars($row['reference']) ?></p>
                                        <p><strong>Service Type:</strong> <?= htmlspecialchars($row['service']) ?></p>
                                        <div class="message-text" style="max-width: 100%; word-wrap: break-word; overflow-wrap: break-word; text-align: justify; margin-bottom:15px;">
